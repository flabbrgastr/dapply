...
STOP = {
    "fuck", "fucked", "fucking", "fucks", "gets", "takes", "with", "and", "the",
    ...
    "porn", "free", "full", "long", "best", "top", "vs", "vs", "v",
    "tube", "com", "www", "http", "https", "html", "page", "amp",
    "via", "w", "please", "get", "see", "use", "let",
    "one", "two", "three", "just", "like", "make", "want", "need",
    "really", "ever", "never", "much", "many", "some", "any", "all",
    "every", "each", "both", "no", "not", "very",
    "na", "da", "de", "do", "da", "em", "para", "com", "sem", "mais",
    "video", "videos", "free", "hd", "xxx", "porn", "pornstar",
    "casal", "novinho", "novinha", "gostoso", "gostosa",
    # Category/gender labels (never performer names)
    "twink", "twinks", "femboy", "femboys", "sissy", "sissies",
    "ladyboy", "ladyboys", "sheboy", "sheboi",
    "bisexual", "bissexual", "heterosexual", "homosexual", "straight", "gay", "gays",
    "lesbian", "lesbians", "trans", "transsexual", "transgender", "cd",
    # Body/ethnicity descriptors
    "blonde", "brunette", "redhead", "ginger",
    "busty", "tattoo", "tattooed", "pierced", "natural", "enhanced",
    "muscular", "muscle", "muscles", "athletic", "slim", "chubby",
    "thick", "skinny", "petite", "curvy", "shapely",
    "asian", "latina", "ebony", "black", "white", "european",
    "brazilian", "brazil", "portuguese", "spanish", "italian", "french", "german",
    "american", "british", "russian", "ukrainian", "polish", "czech",
    # Portuguese/Spanish articles & short function words (never names)
    "a", "as", "o", "os", "um", "uma", "uns", "umas",
    "e", "mas", "ou", "nem", "mas", "pois", "que",
    "lhe", "lhes", "me", "te", "se", "nos", "vos",
    # Portuguese/Spanish high-FP words
    "meu", "minha", "meus", "minhas", "teu", "tua", "teus", "tuas",
    "seu", "sua", "seus", "suas", "nosso", "nossa", "nossos", "nossas",
    "nos", "vos", "lhe", "lhes", "me", "te", "se",
    "que", "como", "quem", "qual", "quais",
    "por", "para", "pela", "pelo", "pelas", "pelos",
    "foi", "era", "sao", "são", "estao", "estão", "esta", "está",
    "este", "esta", "estes", "estas", "isto", "isso", "aquilo",
    "esse", "essa", "esses", "essas", "aquele", "aquela",
    "muito", "muita", "muitos", "muitas", "pouco", "pouca",
    "todo", "toda", "todos", "todas", "varios", "vários", "varias", "várias",
    "entre", "sobre", "durante", "contra", "sem", "sob", "ate", "até",
    "apos", "após", "perto", "longe", "dentro", "fora",
    "antes", "depois", "agora", "sempre", "nunca", "jamais",
    "também", "tambem", "ainda", "ja", "já",
    "peguei", "pegui", "pegou", "flagra", "namorado", "namorada",
    "chico", "chica", "chicas", "chicos",
    "macho", "femea", "fêmea", "homem", "homens", "mulher", "mulheres",
    "cara", "caras", "rapaz", "rapazes",
    "corno", "gozou", "gozar", "goza", "gozado",
    "fodeu", "foder", "fode", "fodia", "fodendo",
    "comeu", "comer", "come", "comendo",
    "chupou", "chupar", "chupa", "chupando",
    "mete", "meter", "meteu", "metendo",
    "buceta", "rabo", "rabuda", "cuzao",
    "cocudo", "sarado", "gostoso", "gostosa",
    "papai", "mamae", "mamãe",
    "cuzinho", "babadinho", "pretinho", "morena",
    "safado", "safada", "safadinho", "safadinha",
    "guloso", "gulosa",
    "tesao", "tesão",
    "putaria", "puta", "puto",
    # Misc noise words that get prefixed to names (e.g. "Piss Bille Star")
    "piss", "cum", "sperm", "semen", "load", "splash",
    # Relationship words that cause false positives
    "daddy", "mommy", "sister", "brother", "friend", "friends",
    "neighbor", "neighbors", "boyfriend", "girlfriend", "wife", "husband",
    "couple", "couples", "solo", "orgy", "gangbang", "group",
    # Descriptive adjectives that cause false positives
    "naughty", "nasty", "dirty", "wild", "crazy", "horny", "slutty", "kinky", "curious",
    "sexy", "erotic", "sensual", "exotic", "beautiful", "gorgeous",
    "stunning", "amazing", "incredible", "fantastic", "wonderful", "awesome",
    "encouragement", "encourage",
    "adorable", "cute", "sweet", "lovely", "charming", "elegant",
    # Episode/series markers
    "episode", "episodes", "season", "volume", "vol",
    "chapter", "series", "compilation", "collection",
    "adventures", "studio", "studios", "production", "productions", "presents",
}
...
COMMON_NOISE = {
    # Colors
    "pink", "blue", "red", "green", "yellow", "purple", "orange", "brown", "gray", "grey",
    "gold", "silver", "bronze", "copper", "scarlet", "crimson", "violet", "blonde",
    # Nouns — never a performer name standing alone
    "girl", "girls", "boy", "boys", "guy", "guys", "man", "men",
    "woman", "women", "lady", "ladies", "wife", "wives", "couple",
    "mom", "mommy", "dad", "daddy", "sister", "brother", "aunt", "uncle",
    "friend", "friends", "neighbor", "neighbors", "lover", "lovers",
    "bride", "maid", "nurse", "cop", "student", "teacher", "boss", "chef",
    "queen", "princess", "prince", "king", "angel", "devil", "demon",
    "hero", "heroine", "star", "superstar", "legend",
    # Descriptors
    "big", "little", "small", "tiny", "huge", "massive", "enormous",
    "curious", "experienced",
    "hot", "cool", "warm", "cold", "sweet", "sour", "bitter", "salty",
    "hard", "soft", "wet", "dry", "tight", "loose", "deep", "shallow",
    "fast", "slow", "quick", "smooth", "rough", "clean", "dirty",
    "happy", "sad", "mad", "glad", "kind", "nice", "mean", "rude",
    "rich", "poor", "young", "old", "new", "fresh", "rare", "pure",
    # Time/direction
    "day", "night", "morning", "evening", "today", "tomorrow", "yesterday",
    "summer", "winter", "spring", "autumn", "fall",
    "north", "south", "east", "west", "central", "middle",
    # Abstract
    "life", "love", "lust", "passion", "desire", "dream", "fantasy",
    "gypsy", "gypsies",
    "world", "earth", "planet", "space", "time", "moment",
    # Place
    "house", "home", "room", "door", "bed", "bath", "pool", "beach",
    "city", "town", "village", "country", "island", "bay", "lake", "river",
}
